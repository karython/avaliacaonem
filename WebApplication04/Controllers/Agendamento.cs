...
namespace WebApplication4.Controllers
{
    public class AgendamentoController : Controller
    {
        ...
        public AgendamentoController(SisMedContext context, IValidator<AdicionarConsultaViewModel> adicionarConsultaValidator, IValidator<EditarConsultaViewModel> editarConsultaValidator)
        {
            _context = context;
        ...
        // GET: AgendamentoController/Adicionar
